/*
* Modifications from FreeRTOS example:
* David Hamilton: added pico standard include and print statements
...
//#include "hardware.h"
#include <stdio.h>
/* DOH Modification Start */
#include "pico/stdlib.h"
#include "pico/multicore.h"
/* DOH Modification End */
 ...
 * function and the event semaphore task.    stdio_init_all();
    while (true) {
        printf("Hello, world!\n");
        sleep_ms(1000);
    }
...
/* DOH Modification End */
    ...
    printf("interrupt synchronized task created\n"); sleep_ms(100);
    ...
    printf("now handing off to the scheduler; bye from here!\n"); sleep_ms(100);
...
uint32_t ulReceivedValue;
    ...
    printf("prvQueueReceiveTask called\n"); sleep_ms(100);
    ...
    for( ;; )
    {
        ...
        printf("Received: %d [%d times]\n", ulReceivedValue, ulCountOfItemsReceivedOnQueue);
    }
}
/*-----------------------------------------------------------*/
...
static void prvEventSemaphoreTask( void *pvParameters )
{
    ...
    printf("prvEventSemaphoreTask called\n"); sleep_ms(100);
    ...
    for( ;; )
    {
        ...
        printf("  [Semaphone count: %d] ... ", ulCountOfReceivedSemaphores);
    }
}
/*-----------------------------------------------------------*/
